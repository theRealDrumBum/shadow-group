 ...
 * finished Magic card renders even before Cardsmith submissions are approved.
 * Registry rows with the same slug replace the bundled copy when they have a
 * stored image; otherwise the in-repo render is kept.
 */
export const cards: OperatorCard[] = [
  {
    ...
    colors: ["Red", "White"],
    role: "Rifleman",
    image: render("breacher-coffee-fueled-vanguard"),
    imageKind: "render",
    collectorNumber: "001",
    expansionCode: "SG",
  ...
  },
  {
    ...
    image: render("sins-seven-deadly-specialist"),
    imageKind: "render",
    collectorNumber: "001",
    expansionCode: "SG",
    expansionName: EXPANSION,
  ...
  },
  {
    ...
    colors: ["White", "Blue", "Black"],
    role: "Combat Controller",
    image: render("sins-plan-d-coordinator"),
    imageKind: "render",
    collectorNumber: "003",
    expansionCode: "SG",
    expansionName: EXPANSION,
  ...
  },
  {
    ...
    image: render("shadow-group-base-camp"),
    imageKind: "render",
    collectorNumber: "004",
    expansionCode: "SG",
    expansionName: EXPANSION,
  ...
  },
  {
    ...
    image: render("sins-blackout-ram"),
    imageKind: "render",
    collectorNumber: "005",
    expansionCode: "SG",
    expansionName: EXPANSION,
